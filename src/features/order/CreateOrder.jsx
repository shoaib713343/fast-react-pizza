    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
         ...
         {!position.latitude && !position.longitude && <span className="absolute top-[3px] right-[3px] sm:right-[5px] sm:top-[5px] z-50">
        ...
        <div className="mb-12 flex items-center gap-5">
          ...
          />
          <label className="font-medium" htmlFor="priority">DO you want to give your order priority?</label>
        </div>
        ...
        <div>
          ...
          >{isSubmitting ? "Placing order..." : `Ordern now for ${formatCurrency(totalPrice)}`}</Button>
        </div>
      </Form>
    </div>
  );
